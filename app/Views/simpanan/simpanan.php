        ...
        <div class="row" style="    background: var(--dark-blue);">
            <div class="col">
                <?php if($simpanan->status_simpanan === 'SUDAH DITARIK') : ?>
                    <a href="/simpanan/add_new" class="action-btn" style="margin: 2.2rem 0 0 2.2rem; padding: 1.8rem" align="center"><h4>Tambah Simpanan</h4></a>
                <?php else : ?>
                    <form action="/simpanan/update">
                        <input type="text" name="no_simpanan" id="" value="<?= $simpanan->no_simpanan ?>" hidden>
                        <input type="text" name="status_simpanan" id="" value='SUDAH DITARIK' hidden>
                        <!-- <input type="submit" class="action-btn value='dwa' style="width: 20%;"> -->
                        <button type="submit" class="btn action-btn">Tarik Simpanan</button>
                    </form>
                <?php endif ?>    
                <table>
                    <thead>
