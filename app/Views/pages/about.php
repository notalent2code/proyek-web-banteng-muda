    ...
    <div class="container about u-pd-small">
        <div class="about-text" style="width: 100%;">
            <h2 class="heading-secondary" style="margin-bottom: -2.5rem">
                ...
                <ul>
                    <p class="u-pd-small">
                    Meningkatkan pendapatan sekaligus kesejahteraan anggota melalui penyaluran dana kredit <br>
                    Meningkatkan stimulus agar timbul keinginan untuk menabung atau meminjam di koperasi <br>
